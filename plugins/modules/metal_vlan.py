...
description: Manage the VLAN in Equinix Metal. You can use *id*, *vxlan* or *tags*
  to lookup the resource. If you want to create new resource, you must provide *metro*.
module: metal_vlan
notes: []
options:
  description:

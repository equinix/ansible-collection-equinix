...
| `provisioning_wait_seconds` | <center>`int`</center> | <center>Optional</center> | How long should the module wait for the device to be provisionedi, in seconds.  **(Default: `300`)** |
...
- `metal_device` - The module object
